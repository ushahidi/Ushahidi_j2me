...
class Conv {
     ...
     * @see #getHandler
     */
    native static int getByteLength(int handler, byte[] b, int offset,
            int len);
     ...
     * @see #getHandler
     */
    native static int byteToChar(int handler, byte[] input,
            int in_offset, int in_len, char[] output, int out_offset,
            int out_len);
     ...
     * @see #getHandler
     */
    native static int charToByte(int handler, char[] input,
            int in_offset, int in_len, byte[] output, int out_offset,
            int out_len);
     ...
     * @see #getHandler
     */
    native static int sizeOfByteInUnicode(int handler, byte[] b,
     ...
     * @see #getHandler
     */
    native static int sizeOfUnicodeInByte(int handler, char[] c,
            int offset, int length);
}